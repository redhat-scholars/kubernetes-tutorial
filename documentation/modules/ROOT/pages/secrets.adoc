...
----
copyToClipboard::deploy-myboot-secrets[]
...
----
copyToClipboard::service-myboot-secrets[]
...
curl $IP:$PORT
----
copyToClipboard::get-endpoint-secrets[]
...
----
copyToClipboard::create-secret-cli-secrets[]
...
kubectl get secrets
----
copyToClipboard::get-secret-cli-secrets[]
...
----
copyToClipboard::describe-secret-cli-secrets[]
...
----
copyToClipboard::get-secret-cli-yaml-secrets[]
...
mypassword
----
copyToClipboard::get-secret-cli-password-secrets[]
...
MyUserName
----
copyToClipboard::get-secret-cli-username-secrets[]
...
----
copyToClipboard::get-secret-kubectl-password-secrets[]
...
----
copyToClipboard::replace-myboot-secrets[]
...
----
copyToClipboard::print-secrets-volume-secrets[]
