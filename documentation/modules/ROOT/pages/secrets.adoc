...
Let's take a look at a deployment that will make use of our newly created secret.  Use kbd:[CMD+p] to open `myboot-deployment-configuration-secret.yml` quickly: 
