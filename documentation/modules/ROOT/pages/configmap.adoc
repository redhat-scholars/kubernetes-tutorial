...
[NOTE]
====
If it's easier to show, you can also use the VSCode editor to show what's in the config map by running (assuming you already have your `KUBE_EDITOR` environment variable set)
