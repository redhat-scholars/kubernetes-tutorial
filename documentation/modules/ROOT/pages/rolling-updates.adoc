...
----
copyToClipboard::deploy-myboot-rolling[]
...
----
copyToClipboard::edit-deployment-replicas-rolling[]
...
kubectl get pods
----
copyToClipboard::edit-deployment-replicas-get-pod-rolling[]
...
kubectl edit deployment myboot
----
copyToClipboard::edit-deployment-v2-rolling[]
...
kubectl get pods
----
copyToClipboard::edit-deployment-v2-get-pod-rolling[]
...
----
copyToClipboard::rollout-v2-rolling[]
...
----
copyToClipboard::describe-rollback-rolling[]
...
----
copyToClipboard::describe-rollback-quarkus-rolling[]
